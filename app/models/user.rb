class User < ApplicationRecord
  ...
  validates :introduction, presence: { message: '自己紹介は必ず入力してください' },
                          length: { minimum: 50, maximum: 200, message: "自己紹介は50文字以上200文字以下で入力してください"},
                          if: :introduction_required?
  ...
  def introduction_required?
    !new_record? || introduction.present?
  end
end
